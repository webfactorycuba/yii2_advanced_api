...
use yii\helpers\Url;
if (class_exists('backend\assets\SwaggerAsset')) {
    backend\assets\SwaggerAsset::register($this);
} else {
    ...
    <head>
        ...
        <style type="text/css">
            ...
            header.site-header.site-header nav .navbar-brand a{
                background: url("<?= \backend\models\settings\Setting::getUrlLogoBySettingAndType(3,1)?>") center left no-repeat !important;
                background-size: 55px 34px !important;
            }
        </style>
            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" data-toggle="collapse" data-target="#navbar-collapse" class="navbar-toggle"><span
                            class="sr-only"><?= Yii::t("backend", "Desplegar"); ?></span><span class="icon-bar"></span><span
                            class="icon-bar"></span><span class="icon-bar"></span></button>
                    <h1 class="navbar-brand"><a href="<?=Url::to(['/docs'])?>"><span><?= Yii::t("backend", "Documentación API"); ?></span></a></h1>
                </div>
                <div id="navbar-collapse" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li class="li-why"><a href="<?=Url::to(['/docs'])?>" style="font-size: 25px; padding-left: 0px"><?= Yii::t("backend", "Documentación API"); ?></a></li>
                    </ul>
                </div>
            </div>
        </nav>
