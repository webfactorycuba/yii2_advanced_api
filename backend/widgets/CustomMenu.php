...
class CustomMenu extends \yii\widgets\Menu
{
     ...
     * @inheritdoc
     */
    public $linkTemplate = '<a href="{url}" target="{target}" target="{target}">{icon} {label}</a>';
    /**
     * @inheritdoc
    ...
    {
        if (isset($item['items'])) {
            $labelTemplate = '<a href="{url}" target="{target}">{icon} {label} <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>';
            $linkTemplate = '<a href="{url}" target="{target}">{icon} {label} <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>';
        } else {
    ...
    protected function normalizeItems($items, &$active)
    {
        foreach ($items as $i => $item) {
            ...
            $items[$i]['target'] = isset($item['target']) ? $item['target'] : '';
