...
use backend\models\support\CronjobTaskSearch;
...
/**
 * CronjobTaskController implements the CRUD actions for CronjobTask model.
 */
class CronjobTaskController extends Controller
{
    ...
    /**
     * Lists all CronjobTask models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new CronjobTaskSearch();
    ...
    /**
     * Displays a single CronjobTask model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CronjobTask model.
     * If creation is successful, the browser will be redirected to the 'index' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new CronjobTask(['status'=>CronjobTask::STATUS_ACTIVE]);
    ...
    /**
     * Updates an existing CronjobTask model.
    ...
    /**
     * Deletes an existing CronjobTask model.
    ...
    /**
     * Finds the CronjobTask model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CronjobTask the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CronjobTask::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
    * Bulk Deletes for existing CronjobTask models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    * @return mixed
    */
